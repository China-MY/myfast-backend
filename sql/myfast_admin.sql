...
CREATE TABLE `sys_menu` (
  ...
  `remark` varchar(500) DEFAULT '' COMMENT '备注',
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2000 DEFAULT CHARSET=utf8mb4 COMMENT='系统菜单表';
...
-- 初始化-部门表数据
-- ----------------------------
INSERT INTO `sys_dept` VALUES (100, 0, '0', '总公司', 0, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', NOW(), '', NULL);
INSERT INTO `sys_dept` VALUES (101, 100, '0,100', '研发部门', 1, '研发负责人', '15888888881', 'rd@example.com', '0', '0', 'admin', NOW(), '', NULL);
INSERT INTO `sys_dept` VALUES (102, 100, '0,100', '市场部门', 2, '市场负责人', '15888888882', 'market@example.com', '0', '0', 'admin', NOW(), '', NULL);
INSERT INTO `sys_dept` VALUES (103, 100, '0,100', '测试部门', 3, '测试负责人', '15888888883', 'test@example.com', '0', '0', 'admin', NOW(), '', NULL);
INSERT INTO `sys_dept` VALUES (104, 100, '0,100', '财务部门', 4, '财务负责人', '15888888884', 'finance@example.com', '0', '0', 'admin', NOW(), '', NULL);
...
INSERT INTO `sys_menu` VALUES (113, '表单构建', 3, 1, 'build', 'tool/build/index', '', 1, 0, 'C', '0', '0', 'tool:build:list', 'build', 'admin', NOW(), '', NULL, '表单构建菜单');
INSERT INTO `sys_menu` VALUES (114, '代码生成', 3, 2, 'gen', 'tool/gen/index', '', 1, 0, 'C', '0', '0', 'tool:gen:list', 'code', 'admin', NOW(), '', NULL, '代码生成菜单');
INSERT INTO `sys_menu` VALUES (115, '系统接口', 3, 3, 'swagger', 'tool/swagger/index', '', 1, 0, 'C', '0', '0', 'tool:swagger:list', 'swagger', 'admin', NOW(), '', NULL, '系统接口菜单');
...
-- ----------------------------
-- 管理员密码是123456
INSERT INTO `sys_user` VALUES (1, 100, 'admin', '管理员', '00', 'admin@example.com', '15888888888', '0', '', '$2b$12$P8yQcnQg1GW/YmxuXb5zJeYjINN6DqMNBVeX75Cm2SrZ4p2J18RMO', '0', '0', '127.0.0.1', NOW(), 'admin', NOW(), '', NULL, '管理员');
INSERT INTO `sys_user` VALUES (2, 101, 'test', '测试用户', '00', 'test@example.com', '15666666666', '1', '', '$2b$12$P8yQcnQg1GW/YmxuXb5zJeYjINN6DqMNBVeX75Cm2SrZ4p2J18RMO', '0', '0', '127.0.0.1', NOW(), 'admin', NOW(), '', NULL, '测试用户');
